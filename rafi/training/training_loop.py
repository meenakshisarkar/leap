...
# Function to save generated frames in an npz file
...
def training_loop(
    ...
    for key in ["train", "val"]:
        folder_path = f'/home/gcsdl/roam-images/data/{key}'
        dataset = VideoDataset(folder_path, transform=transform, num_frames=25, sample_frames=25)
